...
public class FollowController {
    ...
    public ResponseEntity<Void> unfollow(@PathVariable("followerId") Long followerId,
    ...
    public ResponseEntity<List<FollowResponseDto>> getFollowList(@PathVariable("followerId") Long followerId){
