...
public class ArticleController {
    ...
    public ResponseEntity<ArticleResponseDto> createArticle(@RequestBody ArticleRequestDto request){
        ...
        ArticleResponseDto createdArticle = articleService.createArticle(request.getContent(), userId);
    ...
    public ResponseEntity<ArticleResponseDto> updateArticle(@PathVariable("articleId") Long articleId,
                                                            @RequestBody ArticleRequestDto request){
        ArticleResponseDto articleResponseDto = articleService.updateArticle(articleId, request.getContent());
